    ...
    if (first_begin_of_the_frame)
    {
        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
				...
				//if (g_Saver.LoadTexture) window->DrawList->AddImage(Menu::Get().GetTexture(), window->Pos, window->Pos + ImVec2(650, 500), ImVec2(0, 0), ImVec2(1, 1), ImColor(1.f, 1.f, 1.f, g.Style.Alpha));
