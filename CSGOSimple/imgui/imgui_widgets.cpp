...
bool ImGui::SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format, float power) //leet
{
...
bool ImGui::SliderInt(const char* label, int* v, int v_min, int v_max, const char* format) //leet
{
...
bool ImGui::ColorEdit3(const char* label, float col[4], ImGuiColorEditFlags flags)
{
	return ColorEdit4(label, col, ImGuiColorEditFlags_NoInputs | flags);
}
