...
const std::map<size_t, weapon_info> k_weapons_info =
{
	...
	{WEAPON_KNIFE_CSS, {"models/weapons/v_knife_css.mdl", "weapon_knife_css"}},
...
const std::vector<weapon_name> k_knifes_names =
{
	{0, "Default"},
...
const std::vector<weapon_name> k_gloves_names =
{
	{ 0, "Default" },
...
const std::vector<weapon_name> k_weapons_names =
{
	{WEAPON_KNIFE, "Knife"},
	{GLOVE_T_SIDE, "Glove"},
	{7, "AK-47"},
